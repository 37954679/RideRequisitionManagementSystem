...
<body style="background:url('bus1.jpg');background-repeat:no-repeat;background-size:cover">
    <!-- [ Pre-loader ] start -->
    <div class="loader-bg">
    ...
    <nav class="pcoded-navbar">
        <div class="navbar-wrapper">
            ...
            <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="Table bootstrap datatable footable" class="nav-item"><a href="BookingApprove.php">Bookings</a></li>
                   </ul>
            </div>
        </div>  
    </nav>
